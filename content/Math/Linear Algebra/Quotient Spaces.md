...
An alternative way to prove [[The Rank Nullity Theorem|rank nullity]] is to directly show that $dim(V/X)=dim(V)-dim(X)$. It turns out, [[The Rank Nullity Theorem|rank nullity]] is an easy corollary once this is already known. Since complements were used in our original proof for [[The Rank Nullity Theorem|rank nullity]], quotient spaces really do present themselves as a choice-free complement-alternative.