...
tags:
---
The goal is to test various model architectures and saliency methods. I'll try to generate synthetic data that roughly matches the real data that we will receive:
