...
Note that in deeper linear networks, although we can obtain an ODE similar to Equation (9), we can't solve them analytically. In the simulation below, we numerically integrate to obtain solutions.
## Key Findings
