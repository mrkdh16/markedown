...
---
#### Definition.
A vector space over a [[Fields|field]] $F$, or an *$F$-vector space*, is an abelian group $V$ furnished with a scalar multiplication
$$
