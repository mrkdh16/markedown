...
$$
The $P(\mathcal{H})$ term represents our *a priori* belief about the hypothesis. We don't necessarily have to assign any *a priori* preference for a model, that is, we can compare models solely based on their evidence. 
